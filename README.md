...
## API эндпоинт:
   ...
   **http://38.34.78.17:8001/api-fast/view-event**
...
Для нагрузочного тестирования использовался нижеприведённый locustfile.py скрипт.
Он также дублирует системные логи (обрабатываемых событий), их можно наблюдать во вкладке LOGS (открыв браузерный интерфейс locust'а).
